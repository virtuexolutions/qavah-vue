...
export default {
  ...
  methods: {
    ...
    populate_stripe_element() {
      this.stripe = Stripe(
        "pk_test_51JIdZVJehHGbCsaCYiCquX3mKuZDrym2d3EU31L8fDxs8886NBrqsg3rYrp8bHIdl7wvARE7vxLuNfhsrY5SFbCw00tHX5coQC",
        { locale: "en" }
    ...
    submit() {
      ...
      stripe
        .handleCardSetup(this.intent_secrets.client_secret, this.cardElement, {
          payment_method_data: {
