...
// export const apiUrl1 = 'http://127.0.0.1:8000';

// export const apiUrl = 'https://application.qavah.us/api';
// export const Resources_Url = 'https://application.qavah.us';
// export const apiUrl1 = 'https://application.qavah.us';

export const apiUrl = 'https://qavah.us/api';
export const Resources_Url = 'https://qavah.us/';
export const apiUrl1 = 'https://qavah.us/';
