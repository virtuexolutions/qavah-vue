    ...
    <b-overlay :show="loader">
        ...
        <div class="peoples">
          ...
          >
            <div class="left">
              ...
              <div class="info">
                <h4 class="name p-0 m-0">
                  Your current plan does not include this feature. Please
      ...
      <div v-else>
        <div
          ...
          "
        >
          <div class="peoples-container" v-if="profiles && profiles.length > 0">
            <b-card
              no-body
              class="person-item"
              v-for="(person, index) in profiles"
            ...
            >
              <div class="left">
                ...
                <div class="info">
                  ...
                  <p
                    ...
                    v-if="
                      person.who_likes_me_status.liked === 1 &&
                      person.who_likes_me_status.matched === 0 &&
                      person.who_likes_me_status.fancy === 0
                    "
                  >
                    Liked your profile, Awaiting you for a match
                  </p>
                  <p
                    class="status p-0 m-0"
                    v-if="
                      person.who_likes_me_status.liked === 0 &&
                      person.who_likes_me_status.fancy === 1 &&
                      person.who_likes_me_status.matched === 0
                    "
                  >
                    Sent you a fancy, Awaiting you for a match
                  </p>
                  <p
                    class="status p-0 m-0"
                    v-if="
                      person.who_likes_me_status.liked === 0 &&
                      person.who_likes_me_status.fancy === 0 &&
                      person.who_likes_me_status.superlike === 1 &&
                      person.who_likes_me_status.matched === 0
                    "
                  >
                    Superfancy your profile, Awaiting you for a match
                  </p>
                  <p class="time p-0 m-0">
                    <time-ago
                      long
                      :datetime="person.who_likes_me_status.created_at"
                    ></time-ago>
                  </p>
                </div>
              </div>
              ...
              <div class="actions-btns">
                ...
                <b-button
                  ...
                  @click="lo(person.id, person.profileName)"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="20"
                ...
                <b-button
                  ...
                  v-if="
                    person.who_likes_me_status.liked === 1 &&
                    person.who_likes_me_status.fancy === 0 &&
                    person.who_likes_me_status.superlike === 0 &&
                    person.who_likes_me_status.matched === 0
                  "
                  @click="
                    kan(
                ...
                <i
                  v-if="
                    person.status !== 'match' && person.status !== 'blocked'
                  "
                  @click="
                    blockUser(
                      person.id,
                  ...
                  <i
                    ...
                    @click="
                      blockUser(
                        person.id,
                        person.profileName,
                        person.profileImagesPath[0].url
                      )
                    "
                    class="ml-2 block-icon"
                  >
          ...
          <div v-else class="no-likes-yet-container">
            ...
            <b-button
              ...
              @click="$router.push('/dashboard/seeking')"
              >Go to seeking
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="20"
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      setTimeout(() => {
        if (this.currentUser.uid) {
          ...
          axios
            .post(`${apiUrl}/favoured/who-likes-me`, data, { headers })
            .then((response) => {
              // console.log("res -> ", response);
              if (response.status === 200) {
                let data = response.data;

                this.profiles = data.peoples;
                this.loader = false;
              } else {
                this.loader = false;
              }
      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.status === 200) {
            if (data.status) {
              if (data.status) {
                Vue.$toast.default(`You have disliked ${name}!`);
                this.getData();
              } else {
    ...
    superfancy(targetUid, name, targetImage) {
      ...
      axios
        .post(`${apiUrl}/swap/superLiked`, data, { headers })
        .then((response) => {
          // console.log("res -> ", response);
          const data = response.data;
          if (response.status === 200) {
            ...
            if (data.status) {
              if (data.matched) {
                ...
                Vue.$toast.default(`You have superfancy ${name}!`);
                this.getData();
              }
            } else {
              Vue.$toast.error(data.error);
    ...
    fancy(targetUid, name, targetImage) {
      this.loader = true;
          ...
          if (response.status === 200) {
            ...
            if (data.status) {
              if (data.matched) {
                ...
                Vue.$toast.default(`You have sent fancy to ${name}!`);
                this.getData();
              }
            } else {
              Vue.$toast.error(data.error);
    ...
    kan(targetUid, name, targetImage) {
      ...
      axios
        .post(`${apiUrl}/swap/liked`, data, { headers })
        .then((response) => {
          // console.log("res -> ", response);
    ...
    matchMe() {
      ...
      let data = {
        ...
        targetImage: this.profile.moreAboutMe.profileImagesPath[0].url,
        myImage: this.currentUser.photoURL,
      };
