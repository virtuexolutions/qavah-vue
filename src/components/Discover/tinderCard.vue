  ...
  >
    ...
    >
      <template slot-scope="scope">
        ...
        <div class="swiping-card-row-mobile">
          <div class="beliefs-values" v-if="mobileToggleInfo">
            <vue-perfect-scrollbar
              class=""
              :settings="{
                suppressScrollX: true,
              ...
              ref="additionalInfoScroll"
            >
              <div class="beliefs-values-inner pb-4">
                <div class="d-flex justify-content-center align-items-center">
                  <div
                    class="remove-icon m-1"
                    @click="mobileToggleInfo = !mobileToggleInfo"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      height="20"
                ...
                <div class="more-about px-2">
                  ...
                  <p
                    class="m-0 p-0"
                    v-if="scope.data.havePets === 'others'"
                  >
                    pets:

                    <b-badge variant="empty" pill class="left-bubble">{{
                      scope.data.havePetsOthers
                    }}</b-badge>
                  </p>
                  <p class="m-0 p-0">
                    exercise:
                ...
                <div class="isrealite-practice-keeping px-2">
                  <h6 class="mt-2">Isrealite Practice Keeping</h6>
                  <div class="passions-tags-container">
                    <b-badge
                      class="passion-tag"
                      variant="empty"
          ...
          <div class="info-container">
            <div class="info">
              <div>
                ...
                <p class="subtitle p-0 m-0">
                  {{ scope.data.age }} - {{ scope.data.city }},{{
                    scope.data.location.state_abbr
                  }}
                </p>
                <p class="subtitle p-0 m-0">
